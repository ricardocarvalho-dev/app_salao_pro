...
class ConfiguracaoAgendaPage extends StatefulWidget {
  const ConfiguracaoAgendaPage({super.key});

  @override
  _ConfiguracaoAgendaPageState createState() => _ConfiguracaoAgendaPageState();
}

class _ConfiguracaoAgendaPageState extends State<ConfiguracaoAgendaPage> {
        ...
        return StatefulBuilder(builder: (context, setModalState) {
          return Padding(
            ...
            child: Column(
              ...
              children: [
                Text("Configurar: $dataFormatada", style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                const SizedBox(height: 20),
                SwitchListTile(
                  title: const Text("O salão funcionará neste dia?"),
                  value: !estaFechado,
  ...
  Future<void> _salvarConfiguracao(DateTime date, bool trabalha, String motivo) async {
    ...
    try {
      ...
      await supabase.from('agenda_config').upsert({
        ...
        'trabalha': trabalha,
        'motivo': motivo,
      }, onConflict: 'salao_id,data');

      await _carregarBloqueios(); 

      if (mounted) {
        setState(() {
          _selectedDay = null; // LIMPA A SELEÇÃO PARA NÃO FICAR LARANJA
        });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Gerenciar Datas", style: TextStyle(color: t.colorScheme.onPrimary)),
                ...
                child: Container(
                  ...
                  child: TableCalendar(
                    ...
                    calendarStyle: CalendarStyle(
                      ...
                      // Ajuste: Hoje fica apenas com uma borda laranja, não o fundo todo
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Text("Dias marcados como folga/fechado"),
                  ],
                ),
              ),
            ],
